/*
  ...
  - You are about to alter the column `url_slug` on the `posts` table. The data in that column could be lost. The data in that column will be cast from `VarChar(255)` to `VarChar(55)`.
...
-- AlterTable
ALTER TABLE "posts" ALTER COLUMN "url_slug" SET DATA TYPE VARCHAR(55);
