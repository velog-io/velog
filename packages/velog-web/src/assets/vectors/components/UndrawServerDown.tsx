...
const SvgUndrawServerDown = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" viewBox="0 0 1119.609 699" {...props}>
    <circle cx={292.609} cy={213} r={213} fill="#f2f2f2" />
    <path fill="#2f2e41" d="M0 51.142c0 77.498 48.618 140.209 108.7 140.209" />
    <path fill="#20c997" d="M108.7 191.35c0-78.368 54.256-141.783 121.304-141.783" />
    <path fill="#20c997" d="M39.384 58.168c0 73.614 31.003 133.183 69.317 133.183" />
    <path fill="#2f2e41" d="M108.7 191.35c0-100.137 62.711-181.167 140.209-181.167" />
    <path
      fill="#a8a8a8"
    ...
    <path
      ...
      opacity={0.1}
    />
    <rect width={513.253} height={357.52} x={578.433} y={212.689} fill="#2f2e41" rx={18.046} />
    ...
    <path d="M968.978 667.466v6.06h-326.01v-4.848l.449-1.212h325.561z" opacity={0.1} />
    <path fill="#2f2e41" d="M108.609 159h208v242h-208z" />
    <path
      fill="#3f3d56"
      d="M87.609 135h250v86h-250zM87.609 237h250v86h-250zM87.609 339h250v86h-250z"
    />
    <path fill="#20c997" d="M271.609 150h16v16h-16z" opacity={0.4} />
    <path fill="#20c997" d="M294.609 150h16v16h-16z" opacity={0.8} />
    <path fill="#20c997" d="M317.609 150h16v16h-16z" />
    <path fill="#20c997" d="M271.609 251h16v16h-16z" opacity={0.4} />
    <path fill="#20c997" d="M294.609 251h16v16h-16z" opacity={0.8} />
    <path fill="#20c997" d="M317.609 251h16v16h-16z" />
    <path fill="#20c997" d="M271.609 352h16v16h-16z" opacity={0.4} />
    <path fill="#20c997" d="M294.609 352h16v16h-16z" opacity={0.8} />
    <path fill="#20c997" d="M317.609 352h16v16h-16z" />
...
export default SvgUndrawServerDown
