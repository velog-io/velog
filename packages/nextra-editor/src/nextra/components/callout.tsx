...
export function Callout({
  ...
  return (
    <div
      className={cn(
        'nextra-callout nx-mt-6 nx-flex nx-overflow-x-auto nx-rounded-lg nx-border nx-py-2 ltr:nx-pr-4 rtl:nx-pl-4',
        'contrast-more:nx-border-current contrast-more:dark:nx-border-current',
        classes[type],
      )}
    >
      <div
        className="nx-select-none nx-text-xl ltr:nx-pl-3 ltr:nx-pr-2 rtl:nx-pl-2 rtl:nx-pr-3"
        style={{
