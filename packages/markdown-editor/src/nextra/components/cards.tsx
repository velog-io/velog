...
export function Card({
  ...
  if (image) {
    return (
      <NextLink
        ...
        className={cn(
          classes.card,
          'nx-bg-gray-100 nx-shadow hover:nx-shadow-lg dark:nx-border-neutral-700 dark:nx-bg-neutral-800 dark:nx-text-gray-50 dark:hover:nx-border-neutral-500 dark:hover:nx-bg-neutral-700',
        )}
        {...props}
      >
        {children}
  ...
  return (
    <NextLink
      ...
      className={cn(
        classes.card,
        'nx-bg-transparent nx-shadow-sm hover:nx-bg-slate-50 hover:nx-shadow-md dark:nx-border-neutral-800 dark:hover:nx-border-neutral-700 dark:hover:nx-bg-neutral-900',
      )}
      {...props}
    >
      <span
        className={cn(
          classes.title,
          'nx-flex nx-items-center dark:nx-text-neutral-200 dark:hover:nx-text-neutral-50',
        )}
      >
        {icon}
        {title}
