...
function isReactNode(value: unknown): boolean {
  return (
    value == null || typeof value === 'string' || isFunction(value) || isValidElement(value as any)
  )
}
...
export const DEFAULT_THEME: DocsThemeConfig = {
  ...
  search: {
    ...
    loading: function useLoading() {
      const text = LOADING_LOCALES[DEFAULT_LOCALE]
      return <>{text}…</>
    },
    placeholder: function usePlaceholder() {
      const text = PLACEHOLDER_LOCALES[DEFAULT_LOCALE]
      return `${text}…`
    },
  },
  serverSideError: {
