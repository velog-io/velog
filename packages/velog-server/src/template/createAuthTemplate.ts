export const createAuthTemplate = (registered: boolean, code: string) => {
  ...
  <div>
    <div style="width: 400px; margin: 0 auto;">
      ...
      <a href="https://velog.io/${keywords.type}?code=${code}" style="text-decoration: none; text-align:center; display:block; margin: 0 auto; margin-top: 1rem; background: #845ef7; padding-top: 1rem; color: white; font-size: 1.25rem; padding-bottom: 1rem; font-weight: 600; border-radius: 4px;">계속하기</a>
      
      <div style="text-align: center; margin-top: 1rem; color: #868e96; font-size: 0.85rem;">
        <div>위 버튼을 클릭하시거나, 다음 링크를 열으세요: <br/>
        <a style="color: #b197fc;" href="https://velog.io/${keywords.type}?code=${code}">https://velog.io/${keywords.type}?code=${code}</a>
        </div>
        <br/>
